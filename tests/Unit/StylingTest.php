...
class StylingTest extends TestCase
{
    public function test_public_css_entry_points_and_tokens_exist(): void
    {
        ...
        $tabulator = file_get_contents($root.'/resources/css/renderers/tabulator.css');
        ...
        $this->assertStringContainsString('.petak--tabulator .petak__renderer', $structural);
        ...
        $this->assertStringContainsString('.petak .tabulator', $tabulator);
        $this->assertStringContainsString('.tabulator-page[data-page="first"]', $tabulator);
        $this->assertStringContainsString('border-top-color: var(--petak-accent)', $tabulator);
        $this->assertStringContainsString('.tabulator-row.tabulator-row-even', $tabulator);
        $this->assertStringContainsString('.tabulator-cell.tabulator-editing', $tabulator);
        $this->assertStringContainsString('.tabulator-placeholder-contents', $tabulator);
        $this->assertStringContainsString('.tabulator-frozen.tabulator-frozen-left', $tabulator);
